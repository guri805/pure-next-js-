...
const CreateProduct = () => {
  ...
  const [product, setProduct] = useState({ name: "", description: "", price: "", categoryId: "", }); // store the product data in state 
  ...
  const handleCategoryChange = (e) => {
    ...
    setProduct((prevProduct) => ({ ...prevProduct, categoryId: selectedCategoryId }));
  };
